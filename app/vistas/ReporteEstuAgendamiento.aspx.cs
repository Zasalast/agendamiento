...
namespace Prueba1.app.vistas
{
    public partial class ReporteEstuAgendamiento : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            contrll.controlconsulta(gridview1, "select  hora_inicio_asesoria as 'Hora Inicio Asesoria', concat(profesor.primer_nombre,' ',profesor.primer_apellido ) as Instructor,   observaciones as Observaciones from clase_baile_detalle inner join usuario as estudiante on estudiante_fk = estudiante.id_usuario inner join horario on horario_fk = idhorario inner join plantilla_clase_baile on plantilla_fk = idplantilla_agenda inner join usuario as profesor on usuario_fk_plantilla = profesor.id_usuario where estudiante.id_usuario =" + app.Session.id_usuario + " and hora_inicio_asesoria between '" + desde + "' and '" + hasta + "'   and estado='S' and observaciones is not null   order by hora_inicio_asesoria;");
