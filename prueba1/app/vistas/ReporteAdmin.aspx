<%@ Page Language="C#" MasterPageFile="~/app/vistas/Principal.Master" AutoEventWireup="true" CodeBehind="ReporteAdmin.aspx.cs" Inherits="Prueba1.app.vistas.ReporteAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="dinamico">
               <div class="cuadro1">
    <%--<img src="../../Ilustraciones/reportadmin.png" alt="User"  >--%>
        </div>
    <div class="cuadro2">
             <br />
        <br />
    ...
    <br />
    <br />
    <asp:Button ID="Button1Quejas" runat="server" Text="Reporte Quejas" OnClick="Button1Quejas_Click" CssClass="boton7"/>
    <br />
        <br />
