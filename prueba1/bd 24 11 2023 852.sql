...
DROP DATABASE IF EXISTS `proyecto-agendamiento-valeria`;
...
-- Volcando datos para la tabla proyecto-agendamiento-valeria.accion: ~11 rows (aproximadamente)
...
DROP TABLE IF EXISTS `agendamiento_detalle`;
...
-- Volcando datos para la tabla proyecto-agendamiento-valeria.agendamiento_detalle: ~259 rows (aproximadamente)
...
-- Volcando estructura para tabla proyecto-agendamiento-valeria.ciudad
...
-- Volcando datos para la tabla proyecto-agendamiento-valeria.ciudad: ~0 rows (aproximadamente)

-- Volcando estructura para tabla proyecto-agendamiento-valeria.departamento
...
-- Volcando datos para la tabla proyecto-agendamiento-valeria.departamento: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla proyecto-agendamiento-valeria.horario: ~12 rows (aproximadamente)
...
-- Volcando estructura para tabla proyecto-agendamiento-valeria.pais
...
-- Volcando datos para la tabla proyecto-agendamiento-valeria.pais: ~0 rows (aproximadamente)
...
DROP TABLE IF EXISTS `plantilla_agendamiento`;
...
INSERT IGNORE INTO `plantilla_agendamiento` (`idplantilla_agenda`, `rango_tiempo_minutos`, `nombre_plantilla`, `usuario_fk_plantilla`, `rango_cancelar`, `fecha_inicio`, `fecha_fin`, `tema`) VALUES
	(20, 30, 'Juego Grupo', 3, 30, '2022-06-28 00:00:00', '2022-07-28 00:00:00', 'Cancha futbol'),
	(21, 30, 'Ejercicio', 3, 30, '2022-06-28 00:00:00', '2022-07-28 00:00:00', 'Gym'),
	(22, 30, 'Juego Grupo', 3, 30, '2022-06-28 00:00:00', '2022-07-28 00:00:00', 'Cancha tenis'),
	(28, 30, 'Juego Mesa', 3, 30, '2022-07-07 00:00:00', '2022-08-07 00:00:00', 'Ajedrez'),
	(29, 30, 'Terapia', 3, 30, '2022-07-07 00:00:00', '2022-08-07 00:00:00', 'Rumba terapia'),
	(30, 20, 'Juego Mesa', 3, 40, '2022-07-07 00:00:00', '2022-08-07 00:00:00', 'Parquez'),
	(31, 20, 'Artes MArciales', 3, 60, '2022-07-07 00:00:00', '2022-07-07 00:00:00', 'Boxeo'),
	(32, 20, 'Artes MArciales', 3, 60, '2022-07-11 00:00:00', '2022-08-11 00:00:00', 'Karate'),
	(33, 30, 'Torneofutbol', 6, 30, '2023-11-24 00:00:00', '2024-11-24 00:00:00', 'Amazonicos'),
	(34, 30, 'Torneofutbol', 6, 30, '2023-11-24 00:00:00', '2024-11-24 00:00:00', 'Amazonicos');
...
INSERT IGNORE INTO `quejas` (`idqueja`, `descripcion`, `usuario_fk`, `fecha_queja`) VALUES
	(3, 'La admin es demasiado linda', 12, '2023-11-23 17:10:34');

-- Volcando estructura para tabla proyecto-agendamiento-valeria.recurso_fisico
DROP TABLE IF EXISTS `recurso_fisico`;
CREATE TABLE IF NOT EXISTS `recurso_fisico` (
  `idrecurso_fisico` int NOT NULL AUTO_INCREMENT,
  `nombre_recurso_fisico` varchar(50) NOT NULL,
  `ubicacion` varchar(100) NOT NULL,
  PRIMARY KEY (`idrecurso_fisico`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla proyecto-agendamiento-valeria.recurso_fisico: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla proyecto-agendamiento-valeria.servicio
...
-- Volcando datos para la tabla proyecto-agendamiento-valeria.servicio: ~0 rows (aproximadamente)
...
INSERT IGNORE INTO `usuario` (`id_usuario`, `numero_documento`, `primer_nombre`, `segundo_nombre`, `primer_apellido`, `segundo_apellido`, `usuario`, `clave`, `correo`, `id_rol_fk`, `id_identificacion_fk`) VALUES
	...
	(3, '10023832', 'Diego', '', 'Mora', '', 'diego', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'diego@mora.com', 1, 2),
	...
	(11, '1111111111', 'valeria', '', 'salazar', 'serna', 'valeria', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'valeria@gmailcom', 2, 2),
	(12, '222222222222', 'maria', 'alejandra', 'marin', 'galindo', 'alejandra', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'm.marin@gmail.com', 3, 2);
